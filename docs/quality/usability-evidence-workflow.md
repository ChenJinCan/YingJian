...
本工作流用于形成 Ticket 04 和集中验收所需的真人任务证据；只有最终报告同时记录保留/拒绝的交互结构后，才能关闭 Ticket 04。它只接受同一冻结源码提交、真实 iPhone、无口头指导的 2–6 张照片完整任务；Simulator、Debug、演示、主持人代操作和自由文本总结都不计入证据。
